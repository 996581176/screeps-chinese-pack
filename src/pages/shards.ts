const content: PageContent = {
  ...
  content: [
    ...
    {
      "en-US": "World shards are isolated from each other and run your code separately.",
      "zh-CN": " 在世界中的不同位面是独立的，并且会分开运行您的代码。",
    },
    {
      "en-US": "Your creeps can travel between them using special portals.",
      "zh-CN": "通过使用特殊的传送门。您的 creep 可以在不同位面间穿行。",
    },
    ...
    // 分配确认提示
    {
      "en-US": "You're going to re-assign your CPU to the following shards:",
      "zh-CN": "您将要重新分配您的 CPU 到以下 shard：",
      reuse: true,
    },
