...
const content: PageContent = {
  ...
  content: [
    ...
    {
      "en-US": "You need 1 free Power Level in your account to create a new Power Creep.",
      "zh-CN": "需要一个您账号内空余的超能等级来创建一个新的 Power Creep",
    },
    ...
    { "en-US": "Back to Overview", "zh-CN": "返回总览", reuse: true },
    {
      ...
      "zh-CN": (text: string) =>
        text.replace("You have", "您还剩余").replace("experimentation periods left", "个实验期"),
    },
    ...
    // OPERATE_EXTENSION
    {
      "en-US": "Instantly fill",
      "zh-CN": "使用目标（container, storage, terminal）内的能量立即充满房间内 ",
      reuse: true,
    },
    {
      "en-US":
        "of all extensions in the room using energy from the target structure (container, storage, or terminal).",
      "zh-CN": " 的 extension。",
      reuse: true,
    },
    ...
    // OPERATE_TOWER
    {
      "en-US": "Increase damage, repair and heal amount by",
      "zh-CN": "提升 tower 的伤害、修复与治疗效果 ",
      reuse: true,
    },
    ...
    {
      "en-US":
        "Set the level of the factory to the level of the power. This action is permanent, it cannot be undone, and another power level cannot be applied. Apply the same power again to renew its effect.",
      "zh-CN":
        "将 factory 的等级设置为该超能的等级。该操作是永久性的，无法撤销，并且无法用其他等级的同类超能进行覆盖。施加相同等级的超能来重新激活该效果。",
      reuse: true,
    },
    ...
    // REGEN_MINERAL
    {
      "en-US": "mineral units in a deposit every 10 ticks.",
      "zh-CN": " 点矿物于 mineral 中 / 每 10 tick。",
      reuse: true,
    },

    // OPERATE_POWER
    {
      "en-US": "Increase power processing speed of a Power Spawn by",
      "zh-CN": "提高 PowerSpawn 的单次 power 处理速率",
      reuse: true,
    },
    ...
    {
      "en-US": "This action cannot be undone without deleting the creep.",
      "zh-CN": "该操作将无法撤销，除非直接删除该 creep。",
      reuse: true,
    },
    ...
    {
      "en-US":
        "You can activate a 24-hour experimentation period to work on your Power Creeps builds without losing levels.                 During an experimentation period:",
    ...
    },
    {
      ...
      "zh-CN": (text: string) =>
        text
          .replace("You have", "您还有 ")
          .replace("periods left. Would you like to activate it?", " 个试用期，您确定要激活一个么？"),
      reuse: true,
    },
    {
