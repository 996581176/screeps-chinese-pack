...
const content: PageContent = {
  ...
  content: [
    ...
    {
      "en-US":
        "The Controller in this room is already captured by another player. It seems that somebody has come here ahead of you. Please choose another room.",
    ...
    {
      "en-US": "Build an extractor here to mine this mineral deposit.",
      "zh-CN": "在此处建筑一个 extractor 以采集该矿藏。",
      reuse: true,
    },
    { "en-US": "Amount:", "zh-CN": "余量 amount:", reuse: true },
    ...
    {
      "en-US": "This action will consume 1 available safe mode activation. Proceed?",
      "zh-CN": "这将会消耗掉一次安全模式激活次数，确定继续？",
      reuse: true,
    },
    ...
    // 建筑描述
    {
      "en-US": "Contains additional energy which can be used by spawns for spawning bigger creeps.",
      "zh-CN": "为 Spawn 提供生产更大体型 creep 所需要的储能空间。",
      reuse: true,
    },
    {
      "en-US": "Decreases movement cost. Decays over time and requires repair.",
      "zh-CN": "降低移动的消耗。会随着时间推移而老化并需要维护。",
      reuse: true,
    },
    {
      "en-US": "Blocks movement of all creeps. Requires repair after construction.",
      "zh-CN": "能够阻挡所有 creep。建造之后需要维护。",
      reuse: true,
    },
    {
      "en-US":
        "Defends creeps and structures on the same tile and blocks enemy movement. Decays over time and requires repair.",
    ...
    {
      "en-US": "Stores up to 2,000 resource units. Decays over time and requires repair.",
      "zh-CN": "能够存储 2,000 点资源。会随着时间推移而老化并需要维护。",
      reuse: true,
    },
    { "en-US": "Stores up to 1,000,000 resource units.", "zh-CN": "能够存储 1,000,000 点资源。", reuse: true },
    {
      "en-US": "Remotely transfers energy to another Link in the same room.",
      "zh-CN": "能够向同房间的 Link 远距离传送能量。",
      reuse: true,
    },
    { "en-US": "Allows to mine a mineral deposit.", "zh-CN": "允许玩家采集矿物。", reuse: true },
    {
      "en-US": "Produces mineral compounds and boosts creeps.",
      "zh-CN": "能够制造矿物化合物并强化 creep。",
      reuse: true,
    },
    {
      "en-US": "Sends any resources to a\u00A0Terminal in another room.",
      "zh-CN": "能够向另一房间的 Terminal 发送任意资源。",
      reuse: true,
    },
    { "en-US": "Produces trade commodities.", "zh-CN": "能够生产可交易商品。", reuse: true },
    {
      "en-US": "Spawns creeps using energy contained in the room spawns and extensions.",
      "zh-CN": "使用房间内 Spawn 与 Extension 储备的能量生产 creep。",
      reuse: true,
    },
    {
      "en-US": "Provides visibility into a distant room from your script.",
      "zh-CN": "能够使您的脚本获取远处一房间的视野。",
      reuse: true,
    },
    {
      "en-US": "Spawns power creeps with special unique powers.",
      "zh-CN": "能够生产拥有特殊技能的超能 creep。",
      reuse: true,
    },
    {
      "en-US": "Launches a nuke to a distant room dealing huge damage to the landing area.",
      "zh-CN": "能够向远处一房间发射核弹，对命中区域造成巨大伤害。",
      reuse: true,
    },
    ...
    {
      "en-US":
        "While this structure is alive, it will send invader creeps to all rooms in this sector. It also seems there are some valuable resources inside.",
    ...
    // invader core
    {
      "en-US": "This structure is spawned by its parent nearby.",
      "zh-CN": "该建筑由位于附近的父建筑生成",
      reuse: true,
    },
    ...
    {
      "en-US": "This structure emits bright light and splashes of sparks.",
      "zh-CN": "这个建筑散发着亮光，飞溅出火星。",
      reuse: true,
    },
