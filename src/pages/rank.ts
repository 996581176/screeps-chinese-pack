const content: PageContent = {
  ...
  content: [
    ...
    {
      "en-US":
        "The leaderboard of players expansion during a month. You earn rating points for upgrading any of your Controllers.",
      "zh-CN": "本排行统计了玩家在本月的扩张程度。您可以通过升级任何属于您的控制器（Controller）来获得评分。",
    },
    {
      "en-US":
        "The leaderboard of power gained during a month. You earn rating points for processing power in your Power Spawns.",
