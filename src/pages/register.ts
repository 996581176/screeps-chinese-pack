...
const content: PageContent = {
  ...
  content: [
    ...
    {
      "en-US": "Please check your mail and click the link there.",
      "zh-CN": "请检查您的邮件并点击其中的链接。",
      reuse: true,
    },
    ...
    { "en-US": "Please specify your account e-mail address.", "zh-CN": "请输入你账户的邮箱地址。" },
    { "en-US": "Send", "zh-CN": "发送" },
    { "en-US": "This e-mail does not exist.", "zh-CN": "邮箱不存在。", reuse: true },
    {
      ...
      "zh-CN": "我们已向您的帐户地址发送了一封电子邮件，其中包含如何更改密码的说明。",
    },
  ],
};
