const content: PageContent = {
  ...
  content: [
    ...
    {
      selector:
        "body > app2-router-outlet > app-enter-base > aside > div.__intro.--flex.--hcenter.--vcenter.--column > p",
      "zh-CN":
        '在赛季排名中拔得头筹，<br _ngcontent-yvh-c3="">并在和其他玩家的竞争中<br _ngcontent-yvh-c3="">赢取超棒的奖励。',
    },
    {
    ...
    { "en-US": "You have", "zh-CN": "你拥有\u00A0", reuse: true },
    { "en-US": "Activates full unlocked", "zh-CN": "解锁无限CPU点数！" },
    { "en-US": "CPU indefinitely!", "zh-CN": "" },
    /* {
